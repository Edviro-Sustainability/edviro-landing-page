    ...
    <div style="max-width: 700px; margin: 0 auto;">
      ...
      <ol style="margin: 0; padding: 0; list-style: none; display: grid; gap: 1px; background: #D8DED9; border: 1px solid #D8DED9; border-radius: 16px; overflow: hidden;">
        <li style="background: #F9FAF9; padding: 22px 24px;">
          ...
          <p style="margin: 0; font-size: 15.5px; line-height: 1.6; color: #5F6B65;">We walk you through Edviro, then talk through your portfolio: which sites, which systems, and where you already suspect money is going.</p>
        </li>
        <li style="background: #F9FAF9; padding: 22px 24px;">
          <h3 style="margin: 0 0 6px; font-size: 17px; font-weight: 600;">A quote for what you need</h3>
          <p style="margin: 0; font-size: 15.5px; line-height: 1.6; color: #5F6B65;">Priced per connected site and scoped to exactly what your school needs, so you are not paying for the parts you will not use.</p>
        </li>
        <li style="background: #F9FAF9; padding: 22px 24px;">
          <h3 style="margin: 0 0 6px; font-size: 17px; font-weight: 600;">Data, then your initial report</h3>
          <p style="margin: 0; font-size: 15.5px; line-height: 1.6; color: #5F6B65;">We gather your bills and meter data, get Edviro reading your sites, and come back with an initial report on what it found.</p>
        </li>
      </ol>
